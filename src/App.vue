  ...
  <div class="container mx-auto">
    <section>
      <div class="flex">
        <div class="max-w-xs">
          ...
          <!--            </span>-->
          <!--          </div>-->
          <div v-if="validateCoin(ticker)" class="text-sm text-red-600">
    ...
    <div>
      ...
      <input
        v-model="filter"
        type="text"
        class="pr-10 border-gray-300 text-gray-900 focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm rounded-md shadow-md"
        placeholder="Например DOGE"
      />
    </div>
    ...
    <section v-if="sel" class="relative">
      ...
      <div class="flex items-end border-gray-600 border-b border-l h-64">
        <div
          v-for="(col, index) of normalizedGraph"
          :key="index"
          :style="{ height: `${col}%` }"
